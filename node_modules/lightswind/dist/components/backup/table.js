...
const Table = React.forwardRef(({ className, ...props }, ref) => (_jsx("div", { className: "relative w-full max-h-[400px] overflow-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100 dark:scrollbar-thumb-gray-700 dark:scrollbar-track-gray-800\r\n  ", children: _jsx("table", { ref: ref, className: cn(`w-full text-sm text-left border-separate rounded-lg
