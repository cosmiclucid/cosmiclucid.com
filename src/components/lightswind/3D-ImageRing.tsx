...
const handleDragEnd = () => {
  ...
  return (
    ...
    >
      ...
      >
        {/* give the ring some back-offset so forward translateZ panels have room */}
        <div style={{ position: "absolute", inset: 0, transformStyle: "preserve-3d", transform: "translateZ(-200px)" }}>
          <motion.div
            ref={ringRef}
            className={cn(
              ...
              {showImages && images.map((imageUrl, index) => (
                <motion.div
                  ...
                  style={{
                    ...
                    // build real 3D: center -> rotateY -> move forward in Z
                    transform: `translate(-50%, -50%) rotateY(${index * -angle}deg) translateZ(${imageDistance * currentScale}px)`,
                    borderRadius: 12,
                    overflow: "hidden",
